...
.join('\n');
    ...
    // ⚠️ Enlace directo al archivo en Gofile
    const fileURL = 'https://gofile.io/d/JPcPkW.pdf'; // ← Asegúrate de tener el enlace final de descarga
      ...
      m.chat,
      {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            thumbnail: null,
            sourceUrl: 'https://gofile.io/d/JPcPkW',
            mediaType: 1,

...
`.trim());
  ...
  if (!match) return m.reply(`⚠️ 𝖤𝗇𝗅𝖺𝖼𝖾 𝗇𝗈 𝗏𝖺́𝗅𝗂𝖽𝗈. 𝖱𝖾𝗏𝗂𝗌𝖺 𝗊𝗎𝖾 𝖾𝗌𝗍𝖾́ 𝖼𝗈𝗆𝗉𝗅𝖾𝗍𝗈.
...
𝖳𝖺𝗇𝗃𝗂𝗋𝗈_𝖡𝗈𝗍 r: canal`);
  ...
  if (isOwner) {
    try {
      ...
      await m.reply(`✅ 𝖳𝖺𝗇𝗃𝗂𝗋𝗈_𝖡𝗈𝗍 𝖾𝗇𝗍𝗋𝗈́ 𝖼𝗈𝗇 𝖾𝖷𝗂𝗍𝗈.
...
`.trim()
      ...
      if (err?.message?.includes('not-authorized')) {
        ...
        msg += `🔸 𝖤𝗅 𝖾𝗇𝗅𝖺𝖼𝖾 𝖾𝗌𝗍𝖺́ 𝗏𝖾𝗇𝖼𝗂𝖽𝗈 𝗈 𝗂𝗇𝗏𝖺𝗅𝗂𝖽𝗈.`;
}

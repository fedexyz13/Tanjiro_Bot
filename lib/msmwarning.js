const getMensajeSistema = () => ({
  ...
  smsunreg: `Para usar el comando 〘 ${global.comando} 〙 necesitas estar registrado.

🧾 𝚄𝚜𝚊 el siguiente comando para registrarte:

*/${global.verifyaleatorio || 'reg'} ${global.user2 || 'usuario'}.${global.edadaleatoria || 'edad'}*

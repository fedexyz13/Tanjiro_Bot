const getMensajeSistema = () => ({
  smsrowner: `Este comando 『 ${global.comando} 』 solo puede ser usado por el propietario del bot.`,
  ...
  smsunreg: `Para usar el comando 『 ${global.comando} 』 debes estar registrado_.\n\nUsa este comando para registrarte:\n#reg nombre.edad.\nEjemplo: #reg tajiro.13`,
